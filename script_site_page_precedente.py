...
def write_html_nav(site, date_complete, date_complete1, date_complete2):
    ...
    site.write("</a></li>")
    site.write("""<li><a class="active" href="./site_page_precedente.html#entete" id="ici"> """)
...
def write_html_s3_div1(site):
    ...
    site.write("Observation sur les heures précédentes")
    site.write("</h4>")
...
site = open("site_page_precedente.html", "w")
